async function loadMyInvoice() {
    ...
    for (i = 0; i < list.length; i++) {
        main += `<tr>
                    ...
                    <td><span class="span_pending">${list[i].payType != 'PAYMENT_DELIVERY'?'<span class="dathanhtoan">Đã thanh toán</span>':'<span class="chuathanhtoan">Thanh toán khi nhận hàng</span>'}</span></td>
